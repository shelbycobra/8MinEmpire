...
void test_EachCountryBelongsToOneContinent(){
    cout << "\n---------------------------------------" << endl;
    cout << "test_EachCountryBelongsToOneContinent" << endl;
    cout << "---------------------------------------" << endl;
...
void test_SettingAndGettingStartVertex(){
    cout << "\n---------------------------------------" << endl;
    cout << "test_SettingAndGettingStartVertex" << endl;
    cout << "---------------------------------------" << endl;
    ...
    result = map->setStartVertex(startName);
    assert(*start != startName);
    cout << "Failure! Start == " << *start << " and not the excepted \"" << startName << "\"" << endl;
}